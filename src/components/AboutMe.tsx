...
const AboutMe: React.FC = () => {
  ...
  return (
      <React.Fragment>
        <section className="about-me relative mt-16 mb-16" id="about-me" ref={ref}>
          <div className="container flex flex-col items-start px-32 max-lg:px-16">
            {/* Title Container */}
            <div className="title-container flex flex-col gap-6 justify-center items-start w-1/2 max-lg:w-full">
              <motion.div
            ...
            {/* Slider Container */}
            <div className="slider-container w-3/4 max-lg:w-full mt-16 relative overflow-visible">
              <Swiper
                  spaceBetween={100}
                  centeredSlides={true}
                  autoplay={{
                  ...
                  className="w-full pt-32 relative z-2"
              >
                {paragraphs.map((paragraph, index) => (
                    <SwiperSlide
                        key={index}
                        className="bg-[--darkblue] text-[--white] flex flex-col justify-center items-start gap-24 rounded-2xl p-20 border-solid border-[0.4rem] border-[--lightblue] hover:border-orange duration-500 transition-all text-left cursor-grab"
                    >
                      ...
                      <div className="flex flex-row gap-10 max-lg:flex-col">
                        <div className="flex flex-col gap-4 items-center justify-between -mt-10 -mb-10 max-lg:flex-row max-lg:m-0">
                          ...
                          <div className="flex justify-between items-center w-1 h-full max-lg:flex-row max-lg:w-[10rem] max-lg:bg-lightblue">
                            <div></div>
                            <div className="w-[0.5rem] bg-[--lightblue] h-full max-lg:w-10 max-lg:bg-lightblue max-lg:h-[0.25rem]"></div>
                            <div></div>
                          </div>
                          <p className="text-white">
                            <span className="text-orange">&lt;</span>h3
