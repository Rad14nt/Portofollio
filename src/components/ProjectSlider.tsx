                    ...
                    <div className="title-container flex flex-col gap-6 mb-24 rotate-3 justify-between items-center max-lg:w-[100vw]">
                        ...
                        >
                            {projectsData.map((project, index: number) => (
                                ...
                                >
                                    {/* Slide Content */}
                                    <SlideContent project={project} language={language} />
                                </SwiperSlide>
                            ))}
                        </Swiper>
                        {projectsData.map((project, index: number) => (
                            ...
                            >
                                ...
                                />
                                <div className="buttons flex gap-10 max-lg:flex-col"></div>
...
interface SlideContentProps {
    project: typeof projectsData[number]; // Adjust the type according to your projectsData
    language: string;
}

const SlideContent: React.FC<SlideContentProps> = ({ project, language }) => {
    ...
    const handleMouseEnter = () => {
        if (imageRef.current && containerRef.current) {
            ...
            imageRef.current.style.transform = `translateY(-${scrollAmount}px)`;
        }
    };
    ...
    return (
        <>
            <div className="w-[55%] flex flex-col gap-12 justify-between">
                ...
                <div className="technologies">
                    <h3>{language === "DE" ? "Technologien" : "Technologies"}</h3>
                ...
                <div className="buttons flex gap-10"></div>
            </div>

            <div
                className="right-content relative h-[40rem] overflow-hidden rounded-xl w-[40%] transition-all duration-200 shadow-2xl"
                ref={containerRef}
            >
                <img
                    src={project.image}
                    ...
                    ref={imageRef}
                    className="w-full h-auto transition-transform duration-[6000ms] transform opacity-100"
